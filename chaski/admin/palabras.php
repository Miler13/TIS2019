...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de palabras</b></h4></center>
        </div>
      ...
      <div class="panel-body">
            <div class="row">
		               	...
		               	<div class="col-md-6">
                      <button id="nuevo-producto" class="btn btn-success" style="margin-right: 100px"> <i class="glyphicon glyphicon-plus"></i> Nueva Palabra</button> 
 ...
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM pclave"));
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-tasks'></i>&nbsp;&nbsp;Palabras</b></h4>
            </div>
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
               ...
               <div class="form-group"> <label for="subarea" class="col-md-2 control-label">palabra:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="subarea" name="subarea" placeholder="Ingrese la palabras" onkeypress="return sololetras(event)" required maxlength="50"></div>
			   </div> <br>    
