create database Sistema de Laboratorios de informatica-sistemas UMSS;
use Sistema de Laboratorios de informatica-sistemas UMSS;
...
foreign key (Idyear) references years_academicos (idYearAcademico),
