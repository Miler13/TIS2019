       ...
       <br>
        <div class="container">
            ...
            <div class="col-lg-12">
                    ...
                    <li class="active">Backup Sistema de Laboratorios de informatica-sistemas UMSS</li>
                </ol>
            </div>
        </div> 
        <!-- /.row -->
...
<?php //include('otros/menuAdministrador.php') ?>
 ...
 <div class="row">
      ...
      <form action="backup_Sistema de Laboratorios de informatica-sistemas UMSS/Restore.php" method="POST">
        <label>Selecciona un punto de restauración</label>
        <select name="restorePoint" class="form-control" required="true">
            <option value="" disabled="" selected="">Selecciona un punto de restauración</option>
            <?php
                $ruta="backup_Sistema de Laboratorios de informatica-sistemas UMSS/".BACKUP_PATH;
                if(is_dir($ruta)){
                    if($aux=opendir($ruta)){
