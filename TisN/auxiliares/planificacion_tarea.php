...
where idAuxiliar = $codigo and asignaciones.Estado = 1"; 
...
<head>
    ...
    <script src="planificacion_aux/myjava.js"></script>
            ...
            <div class="col-md-3"><img src="../imagenes/logoSIAD.png" width="80" height="80" class="img-responsive"></div>
             <div class="col-md-6">         
              ...
              <div class="col-lg-12">
                    ...
                    <li><a href="auxiliares.php">Auxiliar</a></li>
...
<?php //include('otros/menuAdministrador.php') ?>
 ...
 <br>
    ...
    <?php
include('../admin/conexion.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM planificacion_aux where idAuxiliar = $codigo"));
