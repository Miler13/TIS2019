...
switch($proceso){
	case 'Registro': mysqli_query($conexion,"INSERT INTO planificacion_tareas (idAuxiliar, idNumeroAsignacion, idAsignatura, Unidad, DescripcionUnidad, Tarea, DescripcionTarea, FechaPublicacion, FechaPresentacion, CodigoTarea) VALUES('$codigo','$numero','$asignatura','$unidad','$descripcionU','$tarea','$descripcionT','$fechaPu','$fechaPre','$CodigoTarea')");
	break;
	case 'Edicion': mysqli_query($conexion,"UPDATE planificacion_tareas SET idAuxiliar = '$codigo', idNumeroAsignacion = '$numero',idAsignatura = '$asignatura',Unidad = '$unidad',DescripcionUnidad = '$descripcionU' ,Tarea = '$tarea',DescripcionTarea = '$descripcionT',FechaPublicacion = '$fechaPu' ,FechaPresentacion = '$fechaPre' where idPlanificacion = '$id'");
	break;
   }
...
where planificacion_tareas.idAuxiliar = '$codigo' ORDER BY planificacion_tareas.idPlanificacion ASC");
