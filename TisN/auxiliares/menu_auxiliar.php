<div class="col-md-3">
                <div class="list-group">
                    <a class="list-group-item active">Catalogo del Docente</a>
     <a href="material_aux.php" class="list-group-item"> <i class="glyphicon glyphicon-folder-open"></i>   &nbsp;&nbsp; Material Auxi
                    </a>
        <a href="planificacion_aux.php" class="list-group-item"><i class="glyphicon glyphicon-file"></i>   &nbsp;&nbsp; Planificacion de Tareas
                    </a>
    ...
    <a href="ver_tarea_estudiante.php" class="list-group-item"> <i class="glyphicon glyphicon-edit"></i>   &nbsp;&nbsp; Tarea de Estudiantes
         ...
         <a href="pantalla_reportes.php" class="list-group-item"> <i class="glyphicon glyphicon-list-alt"></i>   &nbsp;&nbsp; Pantalla de Reportes
                    ...
                    <a class="list-group-item active list-group-item-success">Reportes</a>
...
<a href="reportes/Mis_Materiales_Didacticos.php" class="list-group-item"><i class="glyphicon glyphicon-chevron-right"></i>   &nbsp;&nbsp; Material de Aprendizaje
    ...
    <a href="reportes/Tareas_Orientadas_Por_Auxiliares.php" class="list-group-item"><i class="glyphicon glyphicon-chevron-right"></i>   &nbsp;&nbsp; Tareas a los Estudiantes
                    </a>
                </div>
