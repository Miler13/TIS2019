...
$registro = mysqli_query($conexion,"SELECT  material_didactico.idMaterialDidactico AS id, material_didactico.idAuxiliar as idAuxiliar, material_didactico.Descripcion AS Descripcion, material_didactico.Archivo as Archivo, material_didactico.CodigoMaterial as Codigo, material_didactico.Fecha_Subida as Fecha, numeros_asignaciones.numeroAsignado as Numero
...
where material_didactico.idAuxiliar = '$codigo' and material_didactico.Descripcion LIKE '%$dato%' ORDER BY material_didactico.idMaterialDidactico ASC");
