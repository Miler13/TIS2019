...
if(isset($_SESSION['NombreUsuario'])) {
     if ($_SESSION["NivelUsuario"] == 2) {
        ...
        ?>
           <?php 
          $consulta1="select idNumeroAsignacionaux, numeroAsignado FROM numeros_asignacionaux";
...
<head>
    ...
    <script src="material_aux/myjava.js"></script>
 ...
 ?>
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de Material Auxiliar</b></h4></center>
        </div>
                  ...
                  <!--Fin del Segundo Row !-->
                   ...
                   <div class="col-md-5">
		                  <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir la Descripcion del Material">
		               	...
		               	<div class="col-md-6">
                      <a href="material_aux/subirMaterial.php"><button class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nuevo Material </button></a>
		               </div>
	              <br>
 <br>
    ...
    <?php
          include('../admin/conexion.php');
          $numeroRegistros = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM material_aux where idAuxiliar = $codigo"));
