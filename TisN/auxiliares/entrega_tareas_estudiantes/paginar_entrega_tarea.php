...
entrega_tareas.Archivo as Archivo, entrega_tareas.FechaEntrega as Fecha FROM asignacion_aux INNER JOIN asignaturas ON  asignacion_aux.idAsignatura =  asignaturas.idAsignatura 
...
where asignacion_aux.idAuxiliar = '$codigo' group by estudiantes.idEstudiante"));
    $nroLotes = 10;
...
entrega_tareas.Archivo as Archivo, entrega_tareas.FechaEntrega as Fecha FROM asignacion_aux INNER JOIN asignaturas ON  asignacion_aux.idAsignatura =  asignaturas.idAsignatura 
                      INNER JOIN entrega_tareas ON  asignaturas.idAsignatura =  entrega_tareas.idAsignatura 
                     INNER JOIN estudiantes ON  entrega_tareas.idEstudiante =  estudiantes.idEstudiante
where asignacion_aux.idAuxiliar = '$codigo' group by estudiantes.idEstudiante LIMIT $limit, $nroLotes ");
