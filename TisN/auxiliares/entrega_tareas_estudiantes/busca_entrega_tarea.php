...
where asignaciones.idAuxiliar = '$codigo' and asignaturas.NombreAsignatura LIKE '%$dato%' or estudiantes.NombresEstudiante LIKE '%$dato%' group by estudiantes.idEstudiante");
