...
class PDF extends FPDF
{
        ...
        where auxiliares.idAuxiliar = '$Auxiliar' and asignaturas.idAsignatura = '$Asignatura' and grupos.idGrupo = '$Grupo' and turnos.idTurno = '$Turno', and horarios.idHorario = '$Horario' and asignaciones.NumeroAsignacion = '$Numero'");
        ...
        $item = 0;
			while($asignaciones2 = mysqli_fetch_array($asignaciones)){
				...
				$pdf->Cell(40, 8, $asignaciones2['Auxiliar'], 0,'C');
