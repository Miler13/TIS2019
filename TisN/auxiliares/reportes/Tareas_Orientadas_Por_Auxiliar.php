...
function Header()
{
	...
	$this->SetFont('Arial','B',12);
		    $this->Cell(160,20,'Asignaciones del Auxiliar:',0,0,'R');
				$codigo = $_SESSION["Codigo"];
				$asignaciones = mysqli_query($conexion,"SELECT concat(NombresAuxiliar, ' ' ,ApellidosAuxiliar) as Auxiliar FROM auxiliares where idAuxiliar = '$codigo'");
