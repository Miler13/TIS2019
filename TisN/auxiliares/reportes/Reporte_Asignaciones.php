...
class PDF extends FPDF
{
        ...
        $item = 0;
			while($asignacion_aux2 = mysqli_fetch_array($asignacion_aux)){
				...
				$pdf->Cell(35, 8, utf8_decode($asignacion_aux2['Auxiliar']), 0,'C');
				$pdf->Cell(35, 8, utf8_decode($asignacion_aux2['Asignatura']), 0,'C');
				$pdf->Cell(10, 8, $asignacion_aux2['Grupo'], 0,'C');
			    $pdf->Cell(15, 8, $asignacion_aux2['Turno'], 0,'C');
			   	$pdf->Cell(30, 8, $asignacion_aux2['Horario'], 0,'C');
			   	$pdf->Cell(10, 8, $asignacion_aux2['Estado'], 0,'C');
				$pdf->Ln(5);
			}
			$pdf->Ln(8);
