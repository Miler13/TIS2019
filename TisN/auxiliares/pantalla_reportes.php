    ...
    <div class="container">
        ...
        <!-- Page Heading/Breadcrumbs -->
            ...
            <div class="col-lg-12">
                    ...
                    <li class="active">Reportes por Auxiliar</li>
                </ol>
            </div>
        <!-- /.row -->
        ...
        <div class="panel-body">
            ...
            <div class="col-md-4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Tareas Orientadas por Auxiliar</h4>
                        <p>Este reporte muestra las tareas que el Auxiliar ha orientado a sus estudiantes por cada asignatura.</p>
                        <a href="reportes/Tareas_Orientadas_Por_auxiliares.php" class="btn btn-success"><i class="fa fa-eye"></i>  Ver Reporte</a>
                    </div>
                </div>
