                    ...
                    <tr>
                     <th>Codigo</th>
                      ...
                      <th>Opcion</th>
                        ...
                        <?php
                      $consulta=mysqli_query("select idAsignatura, NombreAsignatura from asignaturas ORDER BY idAsignatura desc");
                       if (isset($_POST['carrera'])){
                       $consulta=mysqli_query("select idAsignatura, NombreAsignatura from asignaturas where Idcarrera = '".$_POST['carrera']."' and Idyear = '".$_POST['year']."' and idcuatrimestre = '".$_POST['cuatrimestre']."' ORDER BY idAsignatura desc"); 
                    }
