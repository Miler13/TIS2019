...
$codigo = $_SESSION["Codigo"];
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query("SELECT inscripciones_Asignaturas.idInscripcion as id, inscripciones_Asignaturas.fechaInscripcion as fecha, inscripciones_Asignaturas.observaciones as observaciones, asignaturas.NombreAsignatura as Asignatura, carreras.NombreCarrera as Carrera, years_academicos.NombreYear as Year,  cuatrimestres.NombreCuatrimestre as Cuatrimestre
