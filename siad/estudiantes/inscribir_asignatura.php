                    ...
                    <tr>
                      ...
                      <th>Inscribir Asignatura</th>
                       ...
                       echo "<td colspan='2'>No existen Datos que Mostrar</td>";
                      	...
                      	$consulta=mysqli_query("select idAsignatura, NombreAsignatura from asignaturas where Idcarrera = '".$_POST['carrera']."' and IdGrupo = '".$_POST['grupo']."' and idcuatrimestre = '".$_POST['cuatrimestre']."'ORDER BY idAsignatura desc"); 
