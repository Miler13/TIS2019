...
class PDF extends FPDF
{
		function Header()
		{
			...
			$this->SetFont('Arial','B',13);
             ...
             $id = $_GET['id'];
              $asignaciones = mysqli_query("SELECT NombreAsignatura FROM asignaturas where idAsignatura = '$id'");
		...
		$asignaciones = mysqli_query("SELECT asignaturas.NombreAsignatura as Asignatura, concat(estudiantes.NombresEstudiante,' ' ,estudiantes.ApellidosEstudiante) as Estudiante, inscripciones_asignaturas.fechaInscripcion as Fecha, inscripciones_Asignaturas.observaciones as Observaciones
