...
function Header()
{
	...
	$this->SetFont('Arial','B',12);
		    ...
		    $codigo = $_SESSION["Codigo"];
            $asignaciones = mysqli_query("SELECT concat(NombresDocente, ' ' ,ApellidosDocente) as Docente FROM docentes where idDocente = '$codigo'");
