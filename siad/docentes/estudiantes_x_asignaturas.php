...
if(isset($_SESSION['NombreUsuario'])) {
     if ($_SESSION["NivelUsuario"] == 2) {
        ...
        ?>
          ...
          $asignatura=mysqli_query($consulta2);


                       $consultaD=mysqli_query("select Foto from docentes where idDocente = $codigo");                  
                while($filas=mysqli_fetch_array($consultaD)){
                         $foto=$filas['Foto'];                           
                 }

                 $consultaD2 = mysqli_query("select concat (NombresDocente, ' ', ApellidosDocente) as Docente from docentes where idDocente = $codigo"); 
                     ...
                     <th>Asignatura</th>
                      ...
                      <th>Comentarios</th>
                       ...
                       echo "<td colspan='3'>No existen Estudiantes que Mostrar</td>";
                        ...
                        $consulta=mysqli_query("SELECT asignaturas.idAsignatura as id, asignaturas.NombreAsignatura as Asignatura, concat(estudiantes.NombresEstudiante,' ' ,estudiantes.ApellidosEstudiante) as Estudiante, inscripciones_asignaturas.fechaInscripcion as Fecha, inscripciones_Asignaturas.observaciones as Observaciones
