     ...
     if ($_SESSION["NivelUsuario"] == 2) {
        ...
        ?>
          ...
          $numero=mysqli_query($consulta1);
            ...
            $consulta=mysqli_query("select Foto from docentes where idDocente = $codigo");                  
                while($filas=mysqli_fetch_array($consulta)){
                         $foto=$filas['Foto'];                           
                 }

                 $consulta2 = mysqli_query("select concat (NombresDocente, ' ', ApellidosDocente) as Docente from docentes where idDocente = $codigo"); 
