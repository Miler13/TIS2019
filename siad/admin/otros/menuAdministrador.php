       ...
       include ('conexion.php');
        ...
        $TotalEstudiantes = mysqli_num_rows(mysqli_query("SELECT * FROM estudiantes"));
        $TotalDocentes = mysqli_num_rows(mysqli_query("SELECT * FROM docentes"));
        $TotalAsignaturas = mysqli_num_rows(mysqli_query("SELECT * FROM asignaturas"));
        $TotalCarreras = mysqli_num_rows(mysqli_query("SELECT * FROM carreras"));
        $TotalCuatrimestre = mysqli_num_rows(mysqli_query("SELECT * FROM cuatrimestres"));
        $TotalGrupos = mysqli_num_rows(mysqli_query("SELECT * FROM grupos"));
        $TotalHorarios = mysqli_num_rows(mysqli_query("SELECT * FROM horarios"));
        $TotalTurnos = mysqli_num_rows(mysqli_query("SELECT * FROM turnos"));
        $TotalUsuarios = mysqli_num_rows(mysqli_query("SELECT * FROM usuarios"));
        $TotalYearsAcademicos = mysqli_num_rows(mysqli_query("SELECT * FROM years_academicos"));
        $TotalPlanesEstudio = mysqli_num_rows(mysqli_query("SELECT * FROM plan_estudio"));
        $TotalNumeroAsignaciones = mysqli_num_rows(mysqli_query("SELECT * FROM numeros_asignaciones"));
        $TotalUsuarios = mysqli_num_rows(mysqli_query("SELECT * FROM usuarios"));
        $TotalAsignaciones = mysqli_num_rows(mysqli_query("SELECT * FROM asignaciones"));
        $TotalInscripciones = mysqli_num_rows(mysqli_query("SELECT * FROM inscripciones_asignaturas"));
         $TotalMensajes = mysqli_num_rows(mysqli_query("SELECT * FROM mensajes"));
        ?>
