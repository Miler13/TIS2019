...
include('../conexion.php');
    ...
    $numeroRegistros = mysqli_num_rows(mysqli_query("SELECT * FROM asignaturas"));
    $nroLotes = 10;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysqli_query("SELECT asignaturas.idAsignatura as id, asignaturas.NombreAsignatura as Asignatura, carreras.NombreCarrera as Carrera, grupos.NumeroGrupo as grupo, 
