...
switch($proceso){
	case 'Registro': mysqli_query("INSERT INTO asignaciones (Descripcion, idDocente, idAsignatura, idGrupo, idTurno, idHorario, Estado, NumeroAsignacion) VALUES('$nombre','$docente','$asignatura','$grupo','$turno','$horario','$estado','$numero')");
	break;
	case 'Edicion': mysqli_query("UPDATE asignaciones SET Descripcion = '$nombre', idAsignatura = '$asignatura',idGrupo = '$grupo',idTurno = '$turno',idHorario = '$horario' ,Estado = '$estado',NumeroAsignacion = '$numero' where idAsignacion = '$id'");
	break;
   }
